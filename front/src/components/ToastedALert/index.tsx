...
export default function ToastedALert() {
  return (
    <div className=" fixed bottom-10 left-1/2 transform -translate-x-1/2 flex items-center justify-center bg-blue-300 p-2 rounded-lg w-1/4 shadow-lg z-50 transition-opacity duration-500">
