...
exports.getProductByIdService = exports.getProductsService = exports.checkProductExists = void 0;
...
const getProductByIdService = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield product_repository_1.ProductRepository.findOneBy({ id: productId });
});
